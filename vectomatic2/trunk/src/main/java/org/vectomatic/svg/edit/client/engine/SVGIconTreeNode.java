...
/**
 * {@link org.vectomatic.svg.edit.client.engine.SVGTreeNode} subclass
 * to provide an icon representing the SVG element type of the SVG
 * element represented by this node.
 * @author laaglu
 */
public class SVGIconTreeNode extends SVGTreeNode {
	 ...
	 */
	public SVGIconTreeNode(SVGElement element, List<IProperty> properties) {
		super(element, properties);
	}
	
	/**
	 * Returns the icon representing this node type.
	 * @return The icon representing this node type
	 */
	public AbstractImagePrototype getIcon() {
		return elementNameToIcon.get(element.getTagName());
	}
}
