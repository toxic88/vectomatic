...
public class BitboardUtils {
	...
	public static final long FILE[] = {b_l, b_l>>>1, b_l>>>2, b_l>>>3, b_l>>>4, b_l>>>5, b_l>>>6, b_l>>>7}; // 0 is a, 7 is g
	public static final long FILE_ADJACENTS[] = {
		FILE[1],
		FILE[0] | FILE[1],
		FILE[1] | FILE[3],
		FILE[2] | FILE[4],
	...
	/**
	 * Convert a bitboard square to algebraic notation
	 * Number depends of rotated board.
	 * @param square
	 * @return
	 */
	...
	public static int algebraic2Index(String name) {
		for (int i = 0; i<64; i++) {
			if (name.equals(squareNames[i])) return i;
		}
		return -1;
	}
	...
	public static long algebraic2Square(String name) {
		long aux = H1;
		for (int i = 0; i<64; i++) {
			if (name.equals(squareNames[i])) return aux;
			aux <<= 1;
		}
		return 0;
	}
	...
	/**
	 * gets the file (0..7) of the square
	 * @param square
	 * @return
	 */
